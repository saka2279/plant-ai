...
土みる帳（つちみるちょう） v0.3.2は、カポック・デジタルツインのデモを維持しながら、ELEGOO UNO R3で取得した土壌水分センサーのADC生値を記録・可視化する静的Webアプリです。
...
- v0.3.2ではUNO R3、A0、USBシリアルだけを使用し、BLE、Wi-Fi、Web Serialを追加しない
